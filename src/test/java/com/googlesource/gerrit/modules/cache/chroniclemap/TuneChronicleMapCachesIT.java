...
import static com.googlesource.gerrit.modules.cache.chroniclemap.TuneChronicleMapCaches.CONFIG_HEADER;
import static com.googlesource.gerrit.modules.cache.chroniclemap.TuneChronicleMapCaches.TUNED_INFIX;
...
public class TuneChronicleMapCachesIT extends LightweightPluginDaemonTest {
  ...
  private String cmd = Joiner.on(" ").join("cache-chroniclemap", "tune-chroniclemap-caches");
