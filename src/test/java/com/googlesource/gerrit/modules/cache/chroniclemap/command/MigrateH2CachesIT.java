...
import static com.googlesource.gerrit.modules.cache.chroniclemap.command.MigrateH2Caches.DEFAULT_MAX_BLOAT_FACTOR;
import static com.googlesource.gerrit.modules.cache.chroniclemap.command.MigrateH2Caches.DEFAULT_SIZE_MULTIPLIER;
...
public class MigrateH2CachesIT extends LightweightPluginDaemonTest {
  ...
  @Test
  public void shouldRunAndFailWhenCacheDirectoryIsNotDefined() throws Exception {
