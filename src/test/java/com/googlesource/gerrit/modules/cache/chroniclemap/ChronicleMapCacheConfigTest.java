...
import static com.googlesource.gerrit.modules.cache.chroniclemap.ChronicleMapCacheConfig.Defaults.DEFAULT_PERCENTAGE_HOT_ENTRIES;
...
public class ChronicleMapCacheConfigTest {
  ...
  public void shouldProvidePercentageHotKeysDefault() throws Exception {
    assertThat(configUnderTest(gerritConfig).getpercentageHotKeys()).isEqualTo(DEFAULT_PERCENTAGE_HOT_ENTRIES);
  }
  ...
  public void shouldProvidePercentageHotKeysWhenConfigured() throws Exception {
    ...
    gerritConfig.setInt(
            "cache", cacheKey, "percentageHotKeys", percentageHotKeys);
    gerritConfig.save();

    assertThat(configUnderTest(gerritConfig).getpercentageHotKeys())
            .isEqualTo(percentageHotKeys);
  }
