...
public class ChronicleMapCacheConfigTest {
  ...
  public void shouldNotIncrementCacheMetricWhenDefaultsAreAvailable() {
    ...
    gerritConfig.setLong("cache", configuredCache, "maxEntries", 1L);
    gerritConfig.setLong("cache", configuredCache, "avgKeySize", 1L);
    gerritConfig.setLong("cache", configuredCache, "avgValueSize", 1L);
    gerritConfig.setInt("cache", configuredCache, "maxBloatFactor", 1);
