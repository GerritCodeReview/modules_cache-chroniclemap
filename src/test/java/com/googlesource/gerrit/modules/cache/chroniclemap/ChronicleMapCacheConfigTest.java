...
public class ChronicleMapCacheConfigTest {
  ...
  @Test
  public void shouldProvideDefaultBloatFactorWhenNotConfigured() {
    assertThat(configUnderTest(gerritConfig).getMaxBloatFactor())
        .isEqualTo(DEFAULT_MAX_BLOAT_FACTOR);
  }

  @Test
  public void shouldProvideBloatFactorWhenConfigured() throws Exception {
    int bloatFactor = 3;
    gerritConfig.setInt("cache", cacheKey, "bloatFactor", bloatFactor);
    gerritConfig.save();
