...
public class ChronicleMapCacheImpl<K, V> extends AbstractLoadingCache<K, V>
  ...
  ChronicleMapCacheImpl(
    ...
    ChronicleMapStorageMetrics metrics = new ChronicleMapStorageMetrics();
  ...
  private class ChronicleMapStorageMetrics {
    ...
    ChronicleMapStorageMetrics() {
      ...
      metricMaker.newCallbackMetric(
          ...
          Long.class,
          rateDescription(name),
          () -> (long) store.percentageFreeSpace());
    }

    private Description rateDescription(String cacheName) {
      return new Description(
          String.format("the amount of free space in the %s cache as a percentage", cacheName));
    }
  }
