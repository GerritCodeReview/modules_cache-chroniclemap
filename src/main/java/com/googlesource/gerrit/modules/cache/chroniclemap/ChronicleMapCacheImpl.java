...
public class ChronicleMapCacheImpl<K, V> extends AbstractLoadingCache<K, V>
  ...
  static <K, V> ChronicleMap<KeyWrapper<K>, TimedValue<V>> createStore(
    ...
    ChronicleMap<KeyWrapper<K>, TimedValue<V>> newStore =
    ...
    logger.atInfo().log(
        ...
        newStore.remainingAutoResizes(),
        newStore.percentageFreeSpace());
  ...
  public CacheStats stats() {
    ...
    return new CacheStats(
        hitCount.longValue(),
        missCount.longValue() + memLoader.getMissCount(),
        loadSuccessCount.longValue() + memLoader.getLoadSuccessCount(),
        loadExceptionCount.longValue() + memLoader.getLoadExceptionCount(),
        totalLoadTime.longValue() + memLoader.getTotalLoadTime(),
